      ...
      <div className="container mx-auto w-full max-w-[1320px] px-17 max-md:max-w-full">
        <div className="grid w-full grid-cols-1 items-start gap-10 gap-x-3 md:grid-cols-12 md:gap-x-12 md:gap-y-8">
          <div className="col-span-12 flex flex-col gap-4 md:col-span-6">
            <h2 className="font-display text-deep-green pb-6 text-[32px]/9 font-semibold lg:text-4xl">
              {translation('title')}
            </h2>
              ...
              {BADGES.map(({ src, alt }) => (
                <div key={alt} className="flex justify-start md:justify-center">
                  <Image
                    src={src}
                    alt={alt}
                    className="block h-auto w-full max-w-full object-contain md:w-2/3"
                  />
                </div>
              ))}
            </div>
          ...
          <div className="border-mint-green text-deep-green col-span-12 flex h-full flex-col justify-center gap-4 border-l-2 md:col-span-6">
            <p className="pl-5 font-sans text-xl">
              <em>
            ...
            <h4 className="font-display text-deep-green pt-4 pl-5 text-base">
